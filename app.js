...
// Seed Sequence with Verified YouTube Embed Videos (YouTube-NoCookie Domain)
const seedSequence = [
    {
        journey_id: 'j-001',
        step_index: 1,
        ...
        video: {
            id: 'vid-001',
            youtube_video_id: '3WLaDHYuOEU', // MathAntics - Fractions
    ...
    },
    {
        ...
        video: {
            id: 'vid-002',
            youtube_video_id: 'KnP02qV4p1Q', // SciShow Kids - Numerator & Denominator
    ...
    },
    {
        ...
        video: {
            id: 'vid-003',
            youtube_video_id: 'vKXqzpz-G0s', // Khan Academy - Equivalent Fractions
    ...
    },
    {
        ...
        video: {
            id: 'vid-004',
            youtube_video_id: 'libKVRa074s', // CrashCourse Kids - Tour the Solar System
...
function loadFeedItem(index) {
    ...
    // Clean YouTube NoCookie embed URL format
    const embedUrl = `https://www.youtube-nocookie.com/embed/${item.video.youtube_video_id}?rel=0&controls=1`;
    iframe.src = embedUrl;
