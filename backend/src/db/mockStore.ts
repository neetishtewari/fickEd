export const mockDb = {
  users: [
    {
      ...
      password_hash: '$2a$10$w8T0J4S31E35h7A9w.L.HeFq8kS.E5vE0.wFw1/5F1cK3dE1pP1uO', // Password123!
  ...
  concepts: [
    ...
    { id: 'c-space-02', code: 'SCI-GR5-SPACE-02', subject: 'Science', topic: 'Astronomy', subtopic: 'Sun', title: 'The Power of the Sun', description: 'Star at the center of our solar system', target_grade_min: 4, target_grade_max: 6 },
    { id: 'c-space-03', code: 'SCI-GR5-SPACE-03', subject: 'Science', topic: 'Astronomy', subtopic: 'Planets', title: 'Inner vs Outer Planets', description: 'Rocky terrestrial vs gas giant planets', target_grade_min: 4, target_grade_max: 6 },
  ],
  concept_prerequisites: [
    ...
    { parent_concept_id: 'c-space-01', child_concept_id: 'c-space-02' },
    { parent_concept_id: 'c-space-01', child_concept_id: 'c-space-03' },
  ],
  videos: [
    {
      id: 'vid-001',
